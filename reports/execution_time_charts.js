...
var rtExecTime9030ChartInfo = {
  title: '9030 RT Loop Iteration Time',
  dataKey: "RT_Exec_Test_9030",
  outstandingRequests: 0,
  ...
  CreateUrl: function (build_number) {return `http://vm-dcaf-bld-14:8080/job/Integration/${build_number}/artifact/build_temp/rt_exec_time_9030.json`;},
  DrawChart: DrawExecTimeChart,
};
var requestJenkinsDataRT9030 = createJenkinsDataRequests(rtExecTime9030ChartInfo)
